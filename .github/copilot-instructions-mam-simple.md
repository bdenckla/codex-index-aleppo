...
> **Canonical documentation:** The MAM-simple repo itself has a human-readable version of this guide at [github.com/bdenckla/MAM-simple/doc/reading-mam-simple.md](https://github.com/bdenckla/MAM-simple/blob/main/doc/reading-mam-simple.md). This file is a Copilot-oriented copy with local path references.
...
**Repository:** [github.com/bdenckla/MAM-simple](https://github.com/bdenckla/MAM-simple) (local sibling: `../MAM-simple`)
...
See the MAM-simple repo's `py-example/mb_sefaria/mam4sef_handlers.py` ([on GitHub](https://github.com/bdenckla/MAM-simple/blob/main/py-example/mb_sefaria/mam4sef_handlers.py)) for the complete handler implementations — this is the canonical example of how to process every element type.
...
- **MAM-for-Sefaria** ([github.com/bdenckla/MAM-for-Sefaria](https://github.com/bdenckla/MAM-for-Sefaria)): CSV/HTML format generated from MAM-simple by `py-example/main_mam4sef.py`. Each row is `"Book Ch:Vs","<html_text>"`. This is a *derived* product — the XML is the source.
